...
public final class PhasedTestManager {
    ...
    public static final String STD_PHASED_DEFAULT = "phased-default";
    public static final String STD_PHASED_SINGLE_PROVIDER = "phased-data-provider-single";
    ...
    public static  Object[]  fetchProvidersStandard(Method in_method) {
        ...
        return new Object[] {STD_PHASED_DEFAULT};
    }
    ...
    static Object[][] fetchDataProviderValues(Class<?> in_phasedTestClass) {
        ...
        if (FrameworkDataProvider.class.isAssignableFrom(l_dataProviderClass)) {
            return lr_defaultReturnValue;
        }
